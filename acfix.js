...
(function() {
	...
	if(b != 'zhuzhan' && b != 'letv'){
		if( b == 'iqiyi'){
			c("http://static.skydust.net/private/acfun/AcPlayer201412121_D.swf", "oldcs=1&host=http://www.talkshowcn.com&vid=" + $("a.active.primary").data("vid") + "|youku|" + $("a.active.primary").data("sid"));
